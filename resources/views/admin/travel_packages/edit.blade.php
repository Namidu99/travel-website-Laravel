                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.travel_packages.galleries.store', [$travel_package]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" id="name" placeholder="e.g. Main Entrance">
                                </div>
                            </div>
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           name="name" value="{{ old('name', $travel_package->name) }}" id="name"
                                    ...
                                    <select class="form-control @error('category_id') is-invalid @enderror"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('category_id', $travel_package->category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('district') is-invalid @enderror"
                                           ...
                                           value="{{ old('district', $travel_package->district) }}"
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('best_for') is-invalid @enderror"
                                           id="best_for" name="best_for"
                                           value="{{ old('best_for', $travel_package->best_for) }}"
