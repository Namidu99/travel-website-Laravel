                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.travel_packages.update', [$travel_package]) }}">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="type" value="{{ old('type', $travel_package->type) }}" id="type" placeholder="example: Batik">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                                <label for="Location" class="col-sm-2 col-form-label">Location</label>
                                <div class="col-sm-10">
                                <input text="text" class="form-control" id="Location" name="location" value="{{ old('location', $travel_package->location) }}" placeholder="example: Pilimathalawa,Kandy">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
